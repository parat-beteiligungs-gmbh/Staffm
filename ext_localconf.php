...
TYPO3\CMS\Extbase\Utility\ExtensionUtility::configurePlugin(
        ...
        'Createuser',
        [
            'Mitarbeiter' => 'listCreate, editCreate, saveUserData, listCreated, removeUsername, assignNewMail, removeMail, assignNewPassword, createNewUser, getAllCostCenters, getAllPositions, getAllCompanies, createUser, editCreated, updateCreatedUser, listAllUser, updateAppCostCenter, listAllUserModal, deleteCreatedUser'
        ],
        [
            'Mitarbeiter' => 'listCreate, editCreate, saveUserData, listCreated, removeUsername, assignNewMail, removeMail, assignNewPassword, createNewUser, getAllCostCenters, getAllPositions, getAllCompanies, createUser, editCreated, updateCreatedUser, listAllUser, updateAppCostCenter, listAllUserModal, deleteCreatedUser'
        ]
