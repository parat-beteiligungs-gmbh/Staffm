...
//                $employee->setTxExtbaseType('1'); // TODO-Error: Update doesn´t run! -> set in repository
                ...
                $update = false;
            } elseif (strpos($employee->getTitle (), "Assistentin der Projektleitung Kunststofftechnik") !== false || strpos($employee->getTitle (), "Assistent der Projektleitung Kunststofftechnik") !== false || strpos($employee->getTitle(), "Projektleiter") !== false || (strpos($employee->getTitle(), "Teamleiter") !== false && (strpos($employee->getTitle(), "LFI") !== false || strpos($employee->getTitle(), "RIM") !== false))) {
                $extbaseType = "22";
            }
            // Update?
            if ($update == true) {
