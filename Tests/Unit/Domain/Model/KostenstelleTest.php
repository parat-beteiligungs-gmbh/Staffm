...
/**
 * Test case for class \Pmwebdesign\Staffm\Domain\Model\Kostenstelle.
 *
 ...
 */
class KostenstelleTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	...
	protected function setUp() {
		$this->subject = new \Pmwebdesign\Staffm\Domain\Model\Kostenstelle();
	}
	 ...
	 * @test
	 */
	public function getVerantwortlicherReturnsInitialValueForMitarbeiter() {
		$this->assertEquals(
			NULL,
	 ...
	 * @test
	 */
	public function setVerantwortlicherForMitarbeiterSetsVerantwortlicher() {
		$verantwortlicherFixture = new \Pmwebdesign\Staffm\Domain\Model\Mitarbeiter();
		$this->subject->setVerantwortlicher($verantwortlicherFixture);

		$this->assertAttributeEquals(
			$verantwortlicherFixture,
			'verantwortlicher',
			$this->subject
		);
	}
